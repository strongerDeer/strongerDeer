...
description: "흩어진 서비스 사용 현황을 어떻게 한 기준으로 비교했을까?"
background: "회사 서비스의 사용자 접속 현황을 모니터링·분석하기 위한 대시보드 프로젝트. 데이터 기반 의사결정과 마케팅 전략 수립을 지원하고자 시작."
...
회사에서 운영 중인 다수의 웹 서비스의 실제 사용 현황을 파악하기 위해 제작.
특히 서비스 유지보수에 투입되는 리소스 대비 실제 활용도를 분석해 효율적인 자원 분배가 필요한 상황.
이에 데이터 기반 의사결정을 지원하고 불필요한 운영 리소스를 최적화하기 위한 분석 대시보드를 개발.
