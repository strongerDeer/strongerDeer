...
period: "2024.05"
kor: "위니브 링크"
description: "긴 URL 공유를 어떻게 친근한 사용자 경험으로 만들었을까?"
...
회사의 교안·서비스의 긴 URL을 간단하게 공유하기 위해 제작. 누구나 짧은 URL 생성과 QR코드 이미지 다운로드가 가능하도록 공개.
회사 캐릭터를 활용한 친근하고 재미있는 디자인으로 차별화된 사용자 경험을 제공.
