...
- 주니어로만 구성된 4인 팀의 리드로서 일정 지연과 소통 문제를 주간 회의 체계화와 문서화로 해결
- 메타 태그 최적화, sitemap 설정 등 SEO 기법을 적용하며 검색 노출이 가진 마케팅 효과를 수치로 확인
- 비개발 직군을 위한 마크다운 가이드를 작성하며 사용자 관점의 문서 작성 기준을 정리
