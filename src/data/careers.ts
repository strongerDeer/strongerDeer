...
export const CAREERS: I_CAREERS[] = [
  {
    ...
    description: [
      ...
      "디자인 시스템 설계·운영: 제품별로 달랐던 UI·접근성·토큰 기준을 NDS로 통합해 사내 npm 패키지로 배포. Shop 전역을 NDS 테마로 연결하고 로그인·주문·상품·이벤트 등 166개 제품 코드 파일에서 사용",
      ...
      "가입 경로 개선: 가입 이탈 가설을 바탕으로 SNS 간편가입을 제안하고 로그인 진입 화면을 재설계. 운영 오픈 후 7일간 신규 가입자의 79.4%가 간편가입을 선택",
      ...
      "실시간 채팅 웹앱(PWA) 단독 개발(2025): Sendbird 기반 채팅(17종 메시지 타입), Firebase FCM 백그라운드 알림, Service Worker 캐싱으로 앱 설치 없이 네이티브 수준의 채팅 경험 제공",
    ],
    location: "서울",
  },
  {
    ...
    description: [
      "WeniVooks 웹 교안 서비스 구축 리드(4인 팀): Notion 교안의 학습 흐름 단절·실습 전환 비용·검색 미노출을 문제 정의하고, React SPA 중심 환경에서 신규 서비스에 Next.js(SSR)를 도입해 웹 교안으로 전환 — 런칭 3개월 구글 검색 노출 31.7만 회·클릭 1,746회(Search Console, 2024.05~07)",
