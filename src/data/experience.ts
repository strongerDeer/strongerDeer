...
export const EXPERIENCES = [
...

  {
    ...
    contents: [
      {
        text: "<strong>알아서 잘 딱 깔끔하고 센스있게 정리하는 GitHub 핵심 개념</strong><span>(2022.03)</span>",
        lists: [
  ...
  },
  {
    ...
    contents: [
      {
        text: "<strong>제주 패스파인더</strong> 전지적 주니어 시점 <디자이너에서 개발자로><span>(2024.07.26)</span>",
      },
      {
        text: "<strong>제주대학교</strong> 계절학기 수업 <취업 멘토링><span>(2023.06.26)</span>",
      },
      {
        text: "<strong>제주 오현고등학교</strong> HTML/CSS <나의 좌우명 꾸미기><span>(2022.06.10)</span>",
      },
      {
        text: "<strong>멋쟁이사자처럼</strong> 앱스쿨 특강 <2022 최강 부트캠프 그 전설의 시작: 그걸 내가 써본다><span>(2022.09.27)</span>",
      },
    ],
  },
];
