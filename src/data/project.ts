...
//     kor: "페이지 읽다",
//     description:
//       "독서 기록과 리뷰를 공유하며, 나만의 온라인 책장을 만들 수 있는 개인 독서 기록 관리 웹 서비스",
//     background:
//       "자취를 시작하면서 좁은 집에 책장을 두는 것이 현실적으로 어려웠습니다. 그래서 매년 독서 목표를 세우고 기록하는 개인적인 루틴이 있었으나, 밀리의 서재, 알라딘, 도서관 등 여러 플랫폼에 독서 기록이 흩어져 있어 수기로 관리해야 했고, 연말 독서 결산이나 이전 기록을 확인하는 것도 번거로웠습니다. 또한 매년 어떤 카테고리의 책을 주로 읽는지, 편향된 독서 습관은 없는지 데이터로 확인하고 싶었습니다.이러한 개인적인 니즈와 함께 다른 사람들의 책장도 궁금해졌습니다. 특정 서비스나 앱을 설치하지 않아도, 누구나 쉽게 다른 사람들의 책장을 둘러보고 독서에 흥미를 가질 수 있는 웹 서비스를 만들고 싶었습니다. 그래서 서로의 독서 경험과 취향을 공유할 수 있는 온라인 책장 서비스를 제작하게 되었습니다.",
